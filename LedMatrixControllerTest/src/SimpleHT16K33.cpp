...
// Setup the env
//
void HT16K33::begin(uint8_t address, uint8_t sdaPin, uint8_t sclPin)
{
    uint8_t i;
...
//
uint8_t HT16K33::clearLed(uint8_t ledno)
{ // 16x8 = 128 LEDs to turn on, 0-127
...
// To do it on chip a call to "sendLed" is needed
//
uint8_t HT16K33::setLed(uint8_t ledno)
{ // 16x8 = 128 LEDs to turn on, 0-127
    if (ledno >= 0 && ledno < 128)
    {
...
// To do it on chip a call to "sendLed" is needed
//
uint8_t HT16K33::set7Seg(uint8_t dig, uint8_t cha, boolean dp)
{ // position 0-15, 0-15 (0-F Hexadecimal), decimal point on|off
...
// To do it on chip a call to "sendLed" is needed
//
uint8_t HT16K33::set16Seg(uint8_t dig, uint8_t cha)
{ // position 0-15, 0-15 (0-F Hexadecimal)
